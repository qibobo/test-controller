...
import (
	...
	versioned "github.com/qibobo/test-controller/lib/testresource/generated/clientset/versioned"
	internalinterfaces "github.com/qibobo/test-controller/lib/testresource/generated/informers/externalversions/internalinterfaces"
	v1beta1 "github.com/qibobo/test-controller/lib/testresource/generated/listers/testresource/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.QiboboV1beta1().TestResources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.QiboboV1beta1().TestResources(namespace).Watch(context.TODO(), options)
			},
		},
